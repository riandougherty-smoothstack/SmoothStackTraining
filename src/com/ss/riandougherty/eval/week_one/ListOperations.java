...
public final class ListOperations {
	 ...
	 */
	public static List<Integer> rightDigit(final Collection<Integer> input) {
		return input.stream()
	 ...
	 */
	public static List<Integer> doubling(final Collection<Integer> input) {
		return input.stream()
	 ...
	 */
	public static List<String> noX(final Collection<String> input) {
		return input.stream()
	 ...
	 */
	public static boolean groupSumClump(final List<Integer> input) {
